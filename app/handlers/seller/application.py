...
async def seller_application_start(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        "1/4 — To'liq ismingizni kiriting (F.I.Sh):",
...
async def process_full_name(message: Message, state: FSMContext):
    ...
    await message.answer("2/4 — Telefon raqamingizni yuboring:", reply_markup=phone_keyboard)
...
async def process_phone_contact(message: Message, state: FSMContext):
    ...
    await message.answer("3/4 — Qaysi shaharda yashaysiz? Tanlang:", reply_markup=_city_keyboard())
...
async def process_city(message: Message, state: FSMContext):
    ...
    await message.answer(
        "4/4 — Karta raqamingizni kiriting (16 raqam):\n"
        "Masalan: 8600 1234 5678 9012",
        reply_markup=cancel_keyboard
    )


# ─── 4: Karta raqami (yakuniy) ───────────────────────────────────────────────
